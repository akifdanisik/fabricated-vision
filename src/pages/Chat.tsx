                ...
                <div className="flex justify-center mb-6">
                  <div className="rounded-md border border-neutral-200 p-5">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M21 16V8.00002C21 6.4087 20.3679 4.88259 19.2426 3.75738C18.1174 2.63216 16.5913 2 15 2H9C7.4087 2 5.88258 2.63216 4.75736 3.75738C3.63214 4.88259 3 6.4087 3 8.00002V16C3 17.5913 3.63214 19.1174 4.75736 20.2427C5.88258 21.3679 7.4087 22 9 22H15C16.5913 22 18.1174 21.3679 19.2426 20.2427C20.3679 19.1174 21 17.5913 21 16Z" stroke="#888888" strokeWidth="2" strokeLinejoin="round"/>
                      <path d="M3 10H21" stroke="#888888" strokeWidth="2" strokeLinejoin="round"/>
                      <path d="M7 15H7.01" stroke="#888888" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M11 15H12" stroke="#888888" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
                </div>
                <p className="text-neutral-600 text-sm">Your preview will appear here</p>
              </div>
            </div>
          </div>
        </div>
